...
All the notes are generated by <a href="files/hw-latex.zip" target="_blank">this $$\LaTeX$ file$</a>, which is deliberately designed for students in statistics with a bunch of shortcuts. 
![Latex template](files/tch-notes-fig1.png)
You may use it as the homework template if you'd like.
