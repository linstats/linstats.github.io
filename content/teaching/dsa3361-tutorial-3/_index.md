...
- [Why use `2 × min(p_left, p_right)` instead of `max`?](two-sided-p-value/)
- [Is a permutation distribution always bell-shaped?](permutation-distribution-shape/)
- [How do we choose the quantity for a permutation test?](choosing-test-statistic/)
